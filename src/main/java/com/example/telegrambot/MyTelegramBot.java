...
public class MyTelegramBot extends TelegramLongPollingBot {
    ...
    private void handleAutoBuyStart(long chatId) {
        ...
        sendMessage(chatId, "✅ *Авто-закупка запущена!*\n\n" +
            ...
            "• Сканировать топ новых монет на DEX каждые 3 минуты\n" +
            "• Покупать топ-3 новые монеты\n" +
            "• Валидировать токены перед покупкой\n" +
            "• Держать позиции 30 минут\n" +
            "• Отправлять уведомления о покупках\n\n" +
            "📢 Вы будете получать уведомления о всех операциях!");
